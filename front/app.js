  ...
  setup() {
    ...
    const translations = {
      zh: {
        ...
        trend: { title: '近期利用率', subtitle: '本次浏览会话 · 最近 20 个采样点', cpu: 'CPU', memory: '内存', gpu: 'GPU 平均', waiting: '至少需要 2 个样本，趋势将在下次刷新后显示', details: '查看采样数据', time: '时间', ranges: { session: '实时', '10m': '10分钟', '30m': '30分钟', '1h': '1小时', '6h': '6小时', '12h': '12小时' }, historySubtitle: (range) => `历史数据 · 最近 ${range}`, loadingHistory: '正在加载历史数据...' },
      ...
      ja: {
        ...
        trend: { title: '最近の使用率', subtitle: 'このブラウザーセッション · 最新 20 サンプル', cpu: 'CPU', memory: 'メモリ', gpu: 'GPU 平均', waiting: '2 件以上のサンプルが必要です。次回更新後に表示されます。', details: 'サンプルデータを表示', time: '時刻', ranges: { session: 'リアルタイム', '10m': '10分', '30m': '30分', '1h': '1時間', '6h': '6時間', '12h': '12時間' }, historySubtitle: (range) => `履歴データ · 直近 ${range}`, loadingHistory: '履歴データを読み込み中...' },
    ...
    return {
      ...
      trendRange, trendRanges, historyLoading, trendDisplayRange,
